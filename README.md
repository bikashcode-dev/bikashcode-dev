 ...
 **bankManagemet-appl-backend** `core java · collection framwork · java 8` | Social platform backend — user accounts, post feed, follow/unfollow & interaction APIs with NoSQL modeling. | [![Repo](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/bikashcode-dev/bankManagemet-appl-backend) |
</div>
